...
class BookPreviewViewHolder(parent: ViewGroup, private val onClicked: (BookPreview) -> Unit) :
    BaseViewHolder<BookPreview>(parent.inflate(R.layout.item_book_preview)) {
